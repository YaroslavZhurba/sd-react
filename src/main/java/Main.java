                ...
                .start((req, resp) -> {
                    ...
                    switch (queryType) {
                        case "register":
                            ...
                            response = Observable.just(DataBase.registerUser(new User(id, name, currency)).toString());
                            resp.setStatus(HttpResponseStatus.OK);
                            break;
                        case "get":
                            response = Observable.just("{ id = " + id + ", goods = [")
                                    .concatWith(DataBase.getAllGoods(id))
                        ...
                        case "add":
                            ...
                            response = Observable.just(DataBase.addGood(new Product(id, name, euro, ruble, dollar)).toString());
                            resp.setStatus(HttpResponseStatus.OK);
                            break;
                        default:
